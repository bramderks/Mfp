...
export default function Compare(){
 const rows=[["Categorie",p=>p.category],["Snelheid",p=>p.speed],["Formaat",p=>p.format],["Kleur",p=>p.colour?"Kleur":"Zwart-wit"],["Belangrijkste functies",p=>p.features.slice(0,2).join(" · ")]];
 return <main>
