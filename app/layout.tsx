...
export default function RootLayout({children}:{children:React.ReactNode}){
 return <html lang="nl"><body>
  ...
  <header className="site-header"><div className="container header-inner">
   ...
   <nav className="desktop-nav" aria-label="Hoofdnavigatie"><Link href="/producten">Zakelijke MFP's</Link><Link href="/mfp-kiezen">MFP kiezen</Link><Link href="/oplossingen">Oplossingen</Link><Link href="/software">Software</Link><Link href="/managed-print">Managed print</Link><Link href="/service">Service</Link><Link href="/over-iselto">Over Iselto</Link><Link className="btn btn-secondary nav-cta" href="/mijn-iselto">Mijn Iselto</Link><Link className="btn btn-primary nav-cta" href="/offerte">Offerte aanvragen</Link></nav>
  ...
  <footer className="site-footer"><div className="container footer-grid">
   ...
   <div><b>Iselto</b><p><Link href="/klantverhalen">Klantverhalen</Link></p><p><Link href="/faq">Veelgestelde vragen</Link></p><p><Link href="/kennis">MFP kennis & advies</Link></p><p><Link href="/over-iselto">Over Iselto</Link></p><p><Link href="/vacatures">Vacatures</Link></p><p><Link href="/contact">Contact</Link></p><p><Link href="/mijn-iselto">Mijn Iselto klantomgeving</Link></p></div>
