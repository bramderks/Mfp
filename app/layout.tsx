...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 <nav className="desktop-nav" aria-label="Hoofdnavigatie"><Link href="/producten">Producten</Link><Link href="/oplossingen">Oplossingen</Link><Link href="/managed-print">Managed print</Link><Link href="/diensten">Diensten</Link><Link href="/vergelijker">Vergelijken</Link><Link href="/over-iselto">Over ISELTO</Link><Link href="/zoeken">Zoeken</Link><Link className="btn btn-primary nav-cta" href="/offerte">Offerte aanvragen</Link></nav>
