...
export default function RootLayout({children}:{children:React.ReactNode}){
 return <html lang="nl"><body>
  ...
  <footer className="site-footer"><div className="container footer-grid">
   ...
   <div><b>Iselto</b><p><Link href="/klantverhalen">Klantverhalen</Link></p><p><Link href="/faq">Veelgestelde vragen</Link></p><p><Link href="/seo-mfp">MFP kennis & advies</Link></p><p><Link href="/over-iselto">Over Iselto</Link></p><p><Link href="/vacatures">Vacatures</Link></p><p><Link href="/contact">Contact</Link></p></div>
