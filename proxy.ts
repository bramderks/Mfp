...
export async function proxy(request:NextRequest){
 ...
 if(request.nextUrl.pathname.startsWith("/mijn-iselto")&&!request.nextUrl.pathname.startsWith("/mijn-iselto/login"))return auth.middleware({loginUrl:"/mijn-iselto/login"})(request);
 return response;
}
